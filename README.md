...
* #### Type Safety
This is a key issue to consider in programming as it prevents (or even discourages) data type errors.  You will come across these during your course (and you may have seen a few in your time programming so far).  The style guides below (as well as the introductory information above) have some information on data types.  Chapter 4 of Vlad Riscutia’s book, [“Programming with Types”](https://www.manning.com/books/programming-with-types) elaborates fully on this topic and the TypeScript [website](http://www.typescriptlang.org/docs/handbook/basic-types.html) has more information on the different data types.  You will need to review this information carefully throughout your course, especially if you are not comfortable with a particular programming language.  
* #### Evaluation Rules 
